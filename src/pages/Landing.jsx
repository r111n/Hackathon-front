    ...
    <>
      <div className="w-full">
        <div className="flex h-[90px] items-center px-4 shadow-md">
          <h3 className=" font-bold text-2xl text-blue-600">Hack-a-job</h3>
        </div>
        <div className="h-[70vh] flex justify-center items-center flex-col gap-2">
          <div className=' text-center'>
            <h1 className=" text-slate-800 text-8xl">Simplify finding jobs</h1>
            <h1 className="text-slate-800 text-8xl">
